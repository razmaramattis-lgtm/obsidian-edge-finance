...
export const personalhandbokConfig: GeneratorConfig = {
  ...
  defaultValues: {
    ...
    founded: "", website: "", municipality: "", county: "",
    tariffAgreement: "", tariffArea: "",
    boardChair: "", hrManager: "",
    ...
    volunteerDays: "0",
    environmentPolicy: "",
    workplaceLanguage: "Norsk",
    conflictOfInterestPolicy: "Skal meldes til nærmeste leder",
    intellectualPropertyPolicy: "Alt skapt i arbeidsforhold tilhører bedriften",
  },
  fieldGroups: [
    {
      ...
      fields: [
        ...
        { id: "municipality", label: "Kommune", type: "text", placeholder: "Oslo", helpText: "Kommunen bedriften er registrert i. Kan påvirke lokale forskrifter og avgifter." },
        { id: "county", label: "Fylke", type: "text", placeholder: "Oslo", helpText: "Fylket bedriften tilhører. Relevant for regionale tilskuddsordninger." },
        { id: "tariffAgreement", label: "Tariffavtale", type: "text", placeholder: "F.eks. Tekna/NHO", helpText: "Eventuell tariffavtale bedriften er bundet av. Tariffavtale kan gi utvidede rettigheter utover lovens minimum." },
        { id: "tariffArea", label: "Tariffområde", type: "text", helpText: "Hvilket tariffområde bedriften tilhører (f.eks. NHO, Virke, Spekter). Påvirker lønns- og arbeidstidsbestemmelser." },
        { id: "boardChair", label: "Styreleder", type: "text", helpText: "Navn på styreleder. Relevant for eskalering av saker som gjelder daglig leder." },
        { id: "hrManager", label: "HR-ansvarlig", type: "text", helpText: "Person med hovedansvar for personaladministrasjon, rekruttering og arbeidsmiljø." },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "workplaceLanguage", label: "Arbeidsspråk", type: "text", helpText: "Hovedspråk som brukes i bedriften. Påvirker krav til dokumentasjon og kommunikasjon." },
        { id: "conflictOfInterestPolicy", label: "Interessekonflikt-policy", type: "text", helpText: "Retningslinjer for håndtering av interessekonflikter (kundeforhold, leverandører, familiemedlemmer)." },
        { id: "intellectualPropertyPolicy", label: "Immaterielle rettigheter", type: "text", helpText: "Policy for opphavsrett og immaterielle verdier skapt i arbeidsforholdet. Regulert av åndsverkloven og patentloven." },
        { id: "environmentPolicy", label: "Miljøpolicy", type: "text", helpText: "Bedriftens miljø- og bærekraftspolicy. Inkluderer avfallshåndtering, energibruk og miljøsertifiseringer." },
      ],
    },
    {
      title: "Goder og tillegg",
      fields: [
        { id: "onboardingDays", label: "Onboarding-varighet (dager)", type: "text", helpText: "Antall dager dedikert til onboarding av nye ansatte. Strukturert onboarding øker produktivitet og reduserer turnover." },
        { id: "mentorProgram", label: "Mentorordning", type: "checkbox", helpText: "Om nye ansatte tildeles en mentor/fadder for veiledning i oppstartsperioden." },
        { id: "seniorityBonusDays", label: "Ansiennitetstillegg ferie (dager)", type: "text", helpText: "Ekstra feriedager basert på ansiennitet, utover lovens minimum. F.eks. 1 ekstra dag per 5 års ansiennitet." },
        { id: "telephoneAllowance", label: "Telefonordning", type: "text", placeholder: "F.eks. Bedriftsabonnement", helpText: "Om bedriften dekker mobiltelefon og/eller abonnement for ansatte." },
        { id: "internetAllowance", label: "Internettordning", type: "text", placeholder: "F.eks. Dekkes inntil 500 kr/mnd", helpText: "Om bedriften dekker internett hjemme for ansatte med hjemmekontor." },
        { id: "gymMembership", label: "Treningsabonnement", type: "checkbox", helpText: "Om bedriften dekker eller subsidierer treningsabonnement for ansatte." },
        { id: "healthInsurance", label: "Behandlingsforsikring", type: "checkbox", helpText: "Om bedriften tilbyr privat behandlingsforsikring (helseforsikring) som gir rask tilgang til spesialistbehandling." },
        { id: "dentalInsurance", label: "Tannhelseforsikring", type: "checkbox", helpText: "Om bedriften tilbyr tannhelseforsikring eller støtte til tannbehandling." },
        { id: "employeeDiscount", label: "Personalrabatter", type: "text", helpText: "Eventuelle rabattordninger på bedriftens produkter/tjenester for ansatte." },
        { id: "loanScheme", label: "Lån fra bedriften", type: "checkbox", helpText: "Om bedriften tilbyr lån til ansatte (f.eks. forskudd, rentefritt lån). Skattepliktig fordel over frigrensen." },
        { id: "profitSharing", label: "Resultatdeling", type: "checkbox", helpText: "Om ansatte deler i bedriftens overskudd gjennom utbyttedeling eller resultatbonus." },
        { id: "stockOptions", label: "Aksjeordning/opsjoner", type: "checkbox", helpText: "Om bedriften tilbyr aksjeordning eller opsjoner til ansatte. Regulert av skatteloven § 5-14." },
        { id: "sabbatical", label: "Sabbatsordning", type: "checkbox", helpText: "Om ansatte kan søke om ulønnet permisjon (sabbatsår/sabbatsperiode) for reise, studier eller personlig utvikling." },
        { id: "volunteerDays", label: "Frivillighetsdager/år", type: "text", helpText: "Antall dager per år ansatte kan bruke til frivillig arbeid med lønn. Fremmer samfunnsansvar og engasjement." },
      ],
    },
  ],
  sections: [
