...
export const gdprConfig: GeneratorConfig = {
  ...
  defaultValues: {
    ...
    recordOfProcessingActivities: true,
    jointController: false,
    jointControllerName: "",
    dataDeletionProcedure: "Automatisk og manuell sletting iht. oppbevaringsfrister",
    accessLogReview: "Månedlig",
    encryptionAtRest: true,
    encryptionInTransit: true,
    pseudonymization: false,
    dataMinimizationReview: "Årlig",
    ...
    leadSupervisoryAuthority: "Datatilsynet (Norge)",
  },
  fieldGroups: [
    {
    ...
    {
      title: "Tekniske personverntiltak",
      fields: [
        { id: "encryptionAtRest", label: "Kryptering i ro", type: "checkbox", helpText: "Om lagrede personopplysninger er kryptert (disk, database). Viktig sikkerhetstiltak mot uautorisert tilgang." },
        { id: "encryptionInTransit", label: "Kryptering i transitt", type: "checkbox", helpText: "Om data krypteres under overføring (TLS/SSL). Påkrevd for sensitiv kommunikasjon." },
        { id: "pseudonymization", label: "Pseudonymisering", type: "checkbox", helpText: "Om bedriften benytter pseudonymisering (erstatte identifiserbare data med koder). Reduserer risiko ved datainnbrudd." },
        { id: "accessLogReview", label: "Gjennomgang av tilgangslogg", type: "select", options: ["Månedlig", "Kvartalsvis", "Halvårlig", "Årlig"], helpText: "Hvor ofte tilgangslogger gjennomgås for å oppdage uautorisert tilgang til personopplysninger." },
        { id: "dataDeletionProcedure", label: "Sletteprosedyre", type: "text", helpText: "Prosedyre for sikker sletting av personopplysninger når oppbevaringsfristen utløper eller formålet opphører." },
        { id: "privacyPolicyUrl", label: "Personvernerklæring URL", type: "text", helpText: "URL til bedriftens publiserte personvernerklæring på nettsiden." },
      ],
    },
    {
      title: "Avansert GDPR",
      fields: [
        { id: "privacyByDesign", label: "Innebygd personvern", type: "checkbox", helpText: "Om bedriften følger prinsippet om innebygd personvern (Privacy by Design, GDPR art. 25) ved utvikling av systemer." },
        { id: "dataMinimizationReview", label: "Dataminimering gjennomgang", type: "select", options: ["Kvartalsvis", "Halvårlig", "Årlig"], helpText: "Hvor ofte det vurderes om man samler inn mer data enn nødvendig (prinsippet om dataminimering)." },
        { id: "specialCategoryData", label: "Behandler sensitive data", type: "checkbox", helpText: "Om bedriften behandler særlige kategorier av data (helse, etnisitet, religion, seksualitet, biometri). Krever ekstra beskyttelse." },
        { id: "specialCategoryTypes", label: "Typer sensitive data", type: "text", helpText: "Spesifiser hvilke typer sensitive data som behandles (helseopplysninger, fagforeningsmedlemskap, etc.)." },
        { id: "automatedDecisionMaking", label: "Automatiserte avgjørelser", type: "checkbox", helpText: "Om bedriften bruker automatisert beslutningsstøtte/profilering som påvirker enkeltpersoner vesentlig (GDPR art. 22)." },
        { id: "childrenDataProcessing", label: "Behandling av barns data", type: "checkbox", helpText: "Om bedriften behandler personopplysninger om barn. Krever foreldresamtykke under 16 år (13 år i noen land)." },
        { id: "jointController", label: "Felles behandlingsansvar", type: "checkbox", helpText: "Om bedriften har felles behandlingsansvar med en annen virksomhet (GDPR art. 26). Krever egen avtale." },
        { id: "jointControllerName", label: "Felles behandlingsansvarlig", type: "text", helpText: "Navn på virksomheten det deles behandlingsansvar med." },
        { id: "crossBorderProcessing", label: "Grensekryssende behandling", type: "checkbox", helpText: "Om behandlingen berører registrerte i flere EØS-land. Kan utløse krav om ledende tilsynsmyndighet." },
        { id: "leadSupervisoryAuthority", label: "Ledende tilsynsmyndighet", type: "text", helpText: "Tilsynsmyndigheten som er ledende for grensekryssende behandling. I Norge: Datatilsynet." },
        { id: "dataProtectionCertification", label: "Personvernsertifisering", type: "text", placeholder: "F.eks. ISO 27701", helpText: "Eventuelle sertifiseringer relatert til personvern og informasjonssikkerhet." },
      ],
    },
  ],
  sections: [
