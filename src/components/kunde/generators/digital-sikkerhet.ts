...
export const digitalSikkerhetConfig: GeneratorConfig = {
  ...
  defaultValues: {
    ...
    siemSolution: "",
    socProvider: "",
    penTestFrequency: "Årlig",
    vulnerabilityScanFrequency: "Månedlig",
    zeroTrustApproach: false,
    networkSegmentation: true,
    certificateManagement: "Automatisk via Let's Encrypt",
    apiSecurityPolicy: "OAuth 2.0 / API-nøkler med rotasjon",
    containerSecurity: "",
    cloudSecurityPosture: "",
    dataClassificationTraining: "Ved ansettelse og årlig",
    securityChampionProgram: false,
    bugBountyProgram: false,
    thirdPartyRiskAssessment: "Ved onboarding og årlig",
    supplierSecurityRequirements: "Databehandleravtale og sikkerhetserklæring",
    disasterRecoveryPlan: true,
    rtoTarget: "4 timer",
    rpoTarget: "1 time",
    tabletopExerciseFrequency: "Halvårlig",
  },
  fieldGroups: [
    {
    ...
    },
    {
      ...
      fields: [
        { id: "dlpSolution", label: "DLP-løsning", type: "text", helpText: "Data Loss Prevention (DLP) — system som forhindrer uautorisert deling av sensitiv data (e-post, USB, sky)." },
        { id: "siemSolution", label: "SIEM-løsning", type: "text", helpText: "Security Information and Event Management — samler og analyserer sikkerhetslogger for trusselsdeteksjon." },
        { id: "socProvider", label: "SOC-leverandør", type: "text", helpText: "Security Operations Center — 24/7 overvåking av sikkerhetshendelser, internt eller eksternt." },
        { id: "zeroTrustApproach", label: "Zero Trust-tilnærming", type: "checkbox", helpText: "Om bedriften følger Zero Trust-prinsippet: 'Never trust, always verify'. Alle tilganger verifiseres uavhengig av nettverksposisjon." },
        { id: "networkSegmentation", label: "Nettverkssegmentering", type: "checkbox", helpText: "Om bedriftens nettverk er segmentert for å begrense spredning ved sikkerhetsbrudd." },
        { id: "penTestFrequency", label: "Penetrasjonstesting", type: "select", options: ["Kvartalsvis", "Halvårlig", "Årlig", "Ved behov"], helpText: "Hvor ofte profesjonell penetrasjonstesting gjennomføres for å identifisere sårbarheter." },
        { id: "vulnerabilityScanFrequency", label: "Sårbarhetsskanning", type: "select", options: ["Ukentlig", "Månedlig", "Kvartalsvis"], helpText: "Hvor ofte automatisk sårbarhetsskanning kjøres mot bedriftens systemer og nettverk." },
        { id: "certificateManagement", label: "Sertifikathåndtering", type: "text", helpText: "Hvordan SSL/TLS-sertifikater håndteres og fornyes. Automatisering anbefales." },
        { id: "apiSecurityPolicy", label: "API-sikkerhet", type: "text", helpText: "Policy for sikring av API-er (autentisering, autorisasjon, rate limiting, logging)." },
      ],
    },
    {
      title: "Katastrofegjenoppretting",
      fields: [
        { id: "disasterRecoveryPlan", label: "Katastrofegjenopprettingsplan", type: "checkbox", helpText: "Om bedriften har en dokumentert plan for gjenoppretting etter alvorlige hendelser (brann, naturkatastrofe, cyberangrep)." },
        { id: "rtoTarget", label: "RTO-mål", type: "text", helpText: "Recovery Time Objective — maks akseptabel nedetid før systemer må være operative igjen." },
        { id: "rpoTarget", label: "RPO-mål", type: "text", helpText: "Recovery Point Objective — maks akseptabelt datatap målt i tid. Bestemmer backup-frekvens." },
        { id: "tabletopExerciseFrequency", label: "Beredskapsøvelser", type: "select", options: ["Kvartalsvis", "Halvårlig", "Årlig"], helpText: "Hvor ofte tabletop-øvelser eller simulerte hendelser gjennomføres for å teste beredskapsplaner." },
        { id: "thirdPartyRiskAssessment", label: "Leverandørvurdering", type: "text", helpText: "Prosedyre for vurdering av tredjepartsleverandørers sikkerhetsnivå før og under avtaleperioden." },
        { id: "supplierSecurityRequirements", label: "Sikkerhetskrav til leverandører", type: "text", helpText: "Minimumskrav til sikkerhet hos leverandører (databehandleravtale, sertifiseringer, tilgangslogging)." },
      ],
    },
    {
      title: "Sikkerhetskultur",
      fields: [
        { id: "dataClassificationTraining", label: "Klassifiseringsopplæring", type: "text", helpText: "Opplæring i hvordan ansatte skal klassifisere og håndtere informasjon basert på sensitivitetsnivå." },
        { id: "securityChampionProgram", label: "Security Champion-program", type: "checkbox", helpText: "Om bedriften har utpekte sikkerhetsambassadører i hvert team som fremmer sikkerhetsbevissthet." },
        { id: "bugBountyProgram", label: "Bug Bounty-program", type: "checkbox", helpText: "Om bedriften tilbyr belønning for rapportering av sikkerhetssårbarheter (internt eller eksternt)." },
      ],
    },
  ],
  sections: [
