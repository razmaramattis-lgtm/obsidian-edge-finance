...
export const varslingsrutinerConfig: GeneratorConfig = {
  ...
  defaultValues: {
    ...
    whistleblowerCommittee: false,
    whistleblowerCommitteeMembers: "",
    protectionMeasures: "Identitetsbeskyttelse, tilgangsbegrensning, separate saksmapper",
    feedbackToWhistleblower: true,
    dataProcessingBasis: "Berettiget interesse / rettslig forpliktelse",
    externalLegalSupport: "",
    complianceOfficer: "",
    boardReporting: true,
    statisticsReporting: true,
    cultureInitiatives: "Åpenhetskampanjer, dilemmatrening, etikkuke",
  },
  fieldGroups: [
    {
    ...
    {
      title: "Avansert saksbehandling",
      fields: [
        { id: "caseManagementSystem", label: "Saksbehandlingssystem", type: "text", helpText: "System for håndtering og sporing av varslingssaker. Sikrer at alle saker logges, følges opp og lukkes korrekt." },
        { id: "independentInvestigator", label: "Uavhengig gransker", type: "text", helpText: "Ekstern part som kan gjennomføre uavhengig gransking av alvorlige varslingssaker (advokatfirma, revisor)." },
        { id: "whistleblowerCommittee", label: "Varslingsutvalg etablert", type: "checkbox", helpText: "Om bedriften har et eget varslingsutvalg som vurderer innkomne varsler. Anbefalt for større bedrifter." },
        { id: "whistleblowerCommitteeMembers", label: "Utvalgsmedlemmer", type: "text", helpText: "Sammensetning av varslingsutvalget (f.eks. HR, juridisk, tillitsvalgt, ekstern representant)." },
        { id: "protectionMeasures", label: "Beskyttelsestiltak", type: "text", helpText: "Konkrete tiltak for å beskytte varslerens identitet og hindre gjengjeldelse under saksbehandlingen." },
        { id: "feedbackToWhistleblower", label: "Tilbakemelding til varsler", type: "checkbox", helpText: "Om varsleren skal holdes orientert om sakens fremdrift og utfall. Anbefales for å opprettholde tillit." },
        { id: "complianceOfficer", label: "Compliance-ansvarlig", type: "text", helpText: "Person med overordnet ansvar for etterlevelse av varslingsrutinene og regelverk." },
        { id: "externalLegalSupport", label: "Ekstern juridisk støtte", type: "text", helpText: "Advokatfirma eller juridisk rådgiver som bistår ved komplekse varslingssaker." },
      ],
    },
    {
      title: "Rapportering og kultur",
      fields: [
        { id: "boardReporting", label: "Styreperapportering", type: "checkbox", helpText: "Om varslingssaker rapporteres til styret. Anbefales for transparens og styrets tilsynsansvar." },
        { id: "statisticsReporting", label: "Statistikkrapportering", type: "checkbox", helpText: "Om det utarbeides anonymisert statistikk over varslingssaker (antall, type, utfall) for intern læring." },
        { id: "dataProcessingBasis", label: "Behandlingsgrunnlag GDPR", type: "text", helpText: "GDPR-grunnlag for behandling av personopplysninger i varslingssaker. Vanligvis berettiget interesse eller rettslig forpliktelse." },
        { id: "cultureInitiatives", label: "Kulturtiltak åpenhet", type: "text", helpText: "Tiltak for å fremme åpenhetskultur og senke terskelen for varsling (f.eks. dilemmatrening, etikkuke, kampanjer)." },
      ],
    },
  ],
  sections: [
