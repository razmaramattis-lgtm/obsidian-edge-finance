                  ...
                  {!isInSection ? (
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-6">
                        <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: accentBg(section.id, 0.15) }}>
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-muted-foreground">{section.tagline}</p>
                        </div>
                      </div>
                            ...
                            <div className="flex flex-col gap-0.5">
                              {group.items.map((item) => (
                                <DropdownItem
                                  ...
                                  iconBg={accentBg(section.id, 0.1)}
                                />
                              ))}
                            </div>
                          </div>
