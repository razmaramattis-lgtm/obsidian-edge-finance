      ...
      <div className="relative">
        ...
        {showPicker && (
          <>
            ...
            <div className="hidden sm:block absolute bottom-7 left-0 right-auto bg-card border border-border/30 rounded-xl shadow-2xl shadow-black/40 p-1.5 z-50 animate-in fade-in zoom-in-95 duration-150">
