...
export const sectionPageCopy: Record<SectionId, {
  ...
  hr: {
    ...
    kontakt: {
      ...
      bullets: ["Spesialisert HR-rådgiver", "Lønnskjøring og arbeidsrett inkludert", "Personalhåndbok tilpasset din bedrift", "Rask respons"],
    },
    omOss: {
      tag: "Om Avargo · HR",
  ...
  markedsforing: {
    ...
    kontakt: {
      ...
      bullets: ["Dedikert markedsfører", "SEO, SoMe og Google Ads", "Resultater koblet til regnskap", "Rask respons"],
    },
    omOss: {
  ...
  it: {
    ...
    kontakt: {
      ...
      bullets: ["Skreddersydde nettsider", "AI og automatisering", "Interne systemer og dashboards", "Rask respons"],
    },
    omOss: {
      tag: "Om Avargo · IT",
