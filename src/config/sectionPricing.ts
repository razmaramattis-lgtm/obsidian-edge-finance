...
const regnskapPlans: SectionPricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Budsjett",
      "CFO-løsning",
      "Dedikert rådgivning og strategimøter",
      "Prioritert support og tilgjengelighet",
    ],
    highlighted: true,
  },
];
...
const hrCopy: SectionPricingCopy = {
  ...
  comparisons: [
    { name: "Frilans HR-konsulenter", body: "Kompetente, men dyre per time. Og ingen er der når du trenger dem mellom oppdragene.", us: "Hos Avargo har du en fast HR-rådgiver som kjenner bedriften din — med rask respons.", tag: "Rask respons." },
