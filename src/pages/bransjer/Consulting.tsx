...
const Consulting = () => (
  <BransjePage
    ...
    whyAvargo={[
      ...
      { num: "03", title: "Rask respons når det gjelder.", desc: "Som konsulent tar du ofte beslutninger raskt. Du skal kunne kontakte oss og få rask respons på hverdager." },
    ]}
    relatedSlugs={[
