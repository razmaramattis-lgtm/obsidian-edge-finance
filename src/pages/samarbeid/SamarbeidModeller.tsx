...
const MODELS = [
  ...
  {
    icon: Handshake,
    title: "Fullt oppkjøp — med videre ansettelse",
    subtitle: "Vi overtar, du fortsetter som ansatt leder",
    points: [
      "Avargo kjøper 100 % av selskapet ditt",
      "Du fortsetter som daglig leder i din avdeling — som ansatt",
      "Du eier ingen andel i selskapet, men får en trygg arbeidsplass",
  ...
  },
  {
    ...
    points: [
      ...
      "Forutsetter at alle Avargos kriterier er oppfylt",
    ],
    highlight: false,
  },
];
