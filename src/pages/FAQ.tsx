...
const categories: FAQCategory[] = [
  {
    ...
    items: [
      ...
      { q: "Hva er forskjellen mellom regnskapsfører og revisor?", a: "En regnskapsfører fører regnskapet ditt løpende gjennom året — bokføring, MVA, lønn og årsregnskap. En revisor kontrollerer regnskapet i etterkant og avgir en uavhengig beretning. De fleste små og mellomstore bedrifter trenger en regnskapsfører, men ikke nødvendigvis revisor. Revisjonsplikten gjelder først ved over 7 MNOK i omsetning, over 5 MNOK i balansesum, eller over 10 årsverk." },
