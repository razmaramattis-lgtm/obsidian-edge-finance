...
const deliverables = [
  "Shopify & WooCommerce-utvikling",
  "Produktpresentasjon og UX-design",
  "Betalingsløsninger og kassen-optimalisering",
  "Integrasjon mot lager- og regnskapssystem",
  "Mobil- og hastighetsoptimalisering",
  "Produktfiltre, søk og navigasjonsstruktur",
  "E-postautomatisering (forlatt handlekurv etc.)",
  "Analyse og konverteringsoppfølging",
];

const approach = [
  { num: "01", title: "Design for konvertering, ikke bare estetikk.", desc: "En vakker nettbutikk som ikke selger er en kostnad. Vi designer med konverteringsmålet i sentrum — intuitiv navigasjon, klar kjøpsflyt og tillitssignaler på riktig sted." },
  { num: "02", title: "Teknisk integrasjon mot resten av selskapet.", desc: "Nettbutikken integreres mot lager, regnskapssystem og logistikk. Som en del av Avargo betyr det at salgsdata automatisk speiles mot de finansielle rapportene dine." },
  { num: "03", title: "Skalerbar infrastruktur.", desc: "Vi bygger for vekst. Om du selger 100 eller 100 000 produkter skal nettbutikken håndtere belastningen — uten friksjon, uten nedetid, uten behov for å bygge på nytt." },
  { num: "04", title: "Automatisering som selger mens du sover.", desc: "Forlatt handlekurv-flows, produktanbefalinger, krysssalg og upsell — vi setter opp automatiseringer som øker gjennomsnittlig ordrestørrelse uten manuell innsats." },
];
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }} className="max-w-4xl">
          ...
          <p className="text-base md:text-xl text-muted-foreground font-light leading-relaxed max-w-2xl mb-10 md:mb-14">
            En nettbutikk som ikke bare ser bra ut — men som konverterer, integrerer og skalerer. Bygget for å selge mens du fokuserer på å drive selskapet.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-14 md:gap-24 items-start">
          <AnimatedSection>
            ...
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl mb-6 leading-snug">
              E-handel fra{" "}
              <span className="italic text-gradient-rose">strategi til skalering.</span>
            </h2>
            <p className="text-muted-foreground font-light leading-relaxed text-sm md:text-base">
              Vi leverer komplette nettbutikkprosjekter — design, utvikling, integrasjoner og lanseringsoptimalisering. Klart til å ta imot bestillinger fra dag én.
            </p>
          </AnimatedSection>
    ...
    <section className="py-24 md:py-40 border-y border-border/10 relative">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        <AnimatedSection>
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl mb-14 md:mb-20 max-w-2xl leading-snug">Slik bygger vi nettbutikker som vokser.</h2>
        </AnimatedSection>
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        <AnimatedSection>
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl mb-5 leading-snug max-w-2xl mx-auto">
            Klar til å selge 24/7?
          </h2>
          <p className="text-muted-foreground font-light mb-10 max-w-md mx-auto text-sm">
            Book en gjennomgang og la oss vise deg hva vi kan bygge for selskapet ditt.
          </p>
