...
const Nettsider = () => (
  <>
    <Helmet>
      <title>Nettsider og digitale flater for bedrifter | Avargo</title>
      <meta name="description" content="Profesjonelle nettsider med SEO, design og utvikling. Konverteringsoptimaliserte løsninger for norske bedrifter — fra landingssider til komplette plattformer." />
