...
const categories = [
    ...
    services: [
      {
        ...
        sub: ["Løpende bokføring & MVA", "Bilagshåndtering & dokumentasjon", "Aksjonærregisteroppgave", "Revisjonstøtte"],
      },
      {
        icon: Receipt,
        href: "/tjenester/lonn",
        title: "Lønn & lønnskjøring",
        desc: "Vi kjører lønn presist og til rett tid — hver eneste måned. Feriepenger, sykepenger, reiseregninger og rapportering til myndighetene er inkludert.",
      ...
      },
      {
        ...
        title: "Årsregnskap & skattemelding",
        desc: "Vi tar ansvar for årsoppgjøret fra start til slutt — slik at du kan fokusere på driften. Alt leveres innen fristen, uten stress.",
        sub: ["Årsregnskap & noter", "Skattemelding for selskap", "Skattemelding for eiere", "Ligningspapirer & dokumentasjon"],
      },
      {
        icon: Briefcase,
        href: "/tjenester/cfo",
      ...
      },
      {
        ...
        title: "Fakturering & innkreving",
        desc: "Vi sørger for at fakturaene går ut i tide, purringer følges opp og pengene faktisk kommer inn. Slik at du slipper å bruke tid på å jage betalinger.",
        sub: ["Utgående fakturering", "Purring & inkassovarsler", "Aldersfordeling & oppfølging", "Integrasjon med regnskapssystem"],
      },
      {
        icon: TrendingUp,
        href: "/tjenester/skatteplanlegging",
        title: "Skatteplanlegging & rådgivning",
        desc: "Proaktiv rådgivning som sikrer at du betaler riktig skatt — verken for mye eller for lite. Vi planlegger gjennom hele året, ikke bare ved årsslutt.",
        sub: ["Lønn vs. utbytte-vurdering", "Fradragsoptimalisering", "Selskapsstrukturering", "Formuesplanlegging"],
      },
      {
        icon: BarChart3,
  ...
  },
  {
    ...
    headline: "Lær det du trenger — fra de som kan det best.",
    intro:
      "Praktiske kurs levert av autoriserte regnskapsførere og fageksperter. Enten du vil forstå grunnlaget selv eller styrke kompetansen i teamet ditt.",
    services: [
      {
        icon: Lightbulb,
        href: "/tjenester/kurs",
        title: "Regnskapskurs",
        desc: "Fra grunnleggende bokføring til avansert skattemelding. Praktiske kurs som gir deg kontroll over egne tall — eller gjør samarbeidet med regnskapsføreren enda bedre.",
        sub: ["Bokføring & bilagshåndtering", "MVA-loven i praksis", "Skattemelding & årsregnskap", "System & internkontroll"],
      },
      {
        icon: Users,
        href: "/tjenester/hr-kurs",
        title: "HR & arbeidsgiveransvar",
        desc: "Kurs i arbeidsrett, lønnsprosesser og personalledelse. For deg som vil forstå regelverket og ta bedre beslutninger som arbeidsgiver.",
        sub: ["Arbeidsmiljøloven i praksis", "Lønn & feriepenger", "Onboarding & offboarding", "Personalhåndbok & reglement"],
      },
      {
        icon: TrendingUp,
        href: "/tjenester/bedriftskurs",
        title: "Skreddersydde bedriftskurs",
        desc: "Vi skreddersyr kursopplegg til ditt team — enten det handler om økonomiforståelse, compliance eller digitale verktøy. Levert fysisk eller digitalt.",
        sub: ["Tilpasset innhold & varighet", "Workshop-format", "Oppfølging & materiell", "Sertifisering & dokumentasjon"],
      },
    ],
  },
];
