...
const industries = [
  {
    ...
    short: "Fra pre-revenue til scale-up. Vi forstår investorrunder, MRR-rapportering og alt mellom.",
  },
  {
    icon: Building2,
    ...
    short: "Full kontroll over portefølje, skatt og likviditet — enten du har én eller hundre enheter.",
  },
  {
    icon: Landmark,
    ...
    short: "Konsernregnskap, utbytte, kapitalforvaltning og skatteoptimalisering på tvers av selskaper.",
  },
  {
    icon: Briefcase,
    ...
    short: "Prosjektøkonomi, fakturering og skatteplanlegging for konsulenter og rådgivningsbyråer.",
  },
  {
    icon: Tractor,
    name: "Landbruk",
    ...
    short: "Jordbruksfradrag, produksjonstilskudd og sesongøkonomi — vi kjenner regelverket.",
  },
  {
    icon: ShoppingCart,
    name: "Varehandel",
    ...
    short: "Lager, innkjøp, marginer og svinn — oversikt som hjelper deg å selge smartere.",
  },
  {
    icon: HardHat,
    name: "Bygg & Anlegg",
    ...
    short: "Prosjektregnskap, anbudskalkylering og fakturering tilpasset byggebransjen.",
  },
  {
    icon: Store,
    ...
    short: "MVA på tvers av landegrenser, betalingsplattformer og automatisert ordreøkonomi.",
  },
  {
    icon: Heart,
    name: "Helse & Velvære",
    ...
    short: "Klinikker, treningssentre og helseforetak — vi tar det administrative mens du hjelper.",
  },
  {
    icon: TrendingUp,
    ...
    short: "Tynne marginer og hektisk drift krever presis økonomi. Vi gir deg oversikten.",
  },
  {
    icon: Users,
    ...
    short: "Enkel og oversiktlig økonomi for salonger, uansett om du er solo eller team.",
  },
  {
    icon: Zap,
    ...
    short: "Elektrikere, rørleggere, malere og tømrere — vi holder orden mens du er ute hos kunder.",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
          ...
          <p className="text-sm text-primary/60 italic font-light mb-10 md:mb-14">
            12 spesialiserte bransjeområder. Én dedikert regnskapsfører som kjenner din.
          </p>
