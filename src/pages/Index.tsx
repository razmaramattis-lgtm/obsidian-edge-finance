...
const Index = () => {
  ...
  return (
    <>
      ...
      {/* METHOD — Step-by-step onboarding */}
      <section id="metoden" className="py-32 md:py-40">
        <div className="container mx-auto px-6">
          <AnimatedSection>
            ...
            <p className="text-muted-foreground text-lg font-light leading-relaxed max-w-xl mb-6">
            ...
            <p className="text-sm text-primary/70 italic font-light mb-20">
              Gjennomsnittlig tid fra første møte til fullt operativt regnskap: <strong className="text-primary not-italic">5 virkedager.</strong>
            </p>
          </AnimatedSection>
          ...
          <div className="relative">
            ...
            <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary/30 via-primary/10 to-transparent hidden md:block -translate-x-1/2" />
            ...
            {[
              ...
              },
              {
                ...
                bullets: ["90+ bankintegrasjoner aktivert automatisk", "Import og kategorisering av historisk data", "Oppsett av mva-rapportering og lønnskjøring", "Integrasjon med eksisterende verktøy (Shopify, Tripletex osv.)"],
                side: "left",
              },
              {
                icon: Bot,
