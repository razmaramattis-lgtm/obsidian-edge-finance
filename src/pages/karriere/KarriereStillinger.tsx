...
const KarriereStillinger = () => {
  ...
  const submitOpenApplication = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      supabase.functions.invoke("notify", {
        body: { type: "open_application", data: { applicant_name: openForm.full_name.trim(), applicant_email: openForm.email.trim(), applicant_phone: openForm.phone.trim(), linkedin_url: openForm.linkedin_url.trim() || null, portfolio_url: openForm.portfolio_url.trim() || null, preferred_category: openForm.preferred_category || null, message: openForm.message.trim() || null, cv_url: cvUrl, cv_file_name: cvFileName } },
      }).catch(() => {});
    }
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-3">Ledige stillinger</h1>
          ...
          <div className="max-w-4xl mx-auto">
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-lg font-medium text-foreground mb-2">Ingen stillinger funnet</p>
      ...
      {/* Open Application */}
      <section className="py-16 md:py-24 bg-muted/5" id="apen-soknad">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3">Fant du ikke drømmejobben?</h2>
            ...
            <AnimatePresence mode="wait">
              {openSubmitted ? (
                ...
                <motion.form key="form" onSubmit={submitOpenApplication} className="glass rounded-2xl border border-border/10 p-6 md:p-8 space-y-4">
