          ...
          <div className="max-w-3xl mx-auto text-center">
            <AnimatedSection>
              ...
              <div className="mt-12 md:mt-16 flex flex-wrap gap-6 md:gap-10 justify-center">
                {(isInSection && section && section.id !== "regnskap"
                  ? [`Dedikerte ${section.shortName.toLowerCase()}-spesialister`, "Rask respons", "Ring oss når du vil — inkludert i prisen"]
                  : ["Statsautoriserte regnskapsførere", "Rask respons", "Ring oss når du vil — inkludert i prisen"]
                ).map((signal) => (
