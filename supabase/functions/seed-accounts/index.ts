...
const ACCOUNTS = [
  ...
  { n: "1000", name: "Utvikling, ervervet", group: "10 Immaterielle eiendeler", types: ["AS","ENK"], desc: "Kjøpte utviklingsprosjekter som oppfyller kravene til balanseføring. Avskrives over forventet økonomisk levetid. Gjelder kun eiendeler ervervet fra tredjepart.", ex: "Oppkjøpt teknologiplattform, ervervet programvareprosjekt" },
  { n: "1005", name: "Utvikling, egenutviklet", group: "10 Immaterielle eiendeler", types: ["AS","ENK"], desc: "Kostnader til egenutviklede immaterielle verdier som kan balanseføres når teknisk gjennomførbarhet og fremtidig inntjening er sannsynliggjort.", ex: "Egenutviklet app, intern programvareutvikling, FoU-prosjekt" },
  { n: "1070", name: "Utsatt skattefordel", group: "10 Immaterielle eiendeler", types: ["AS"], desc: "En eiendel som oppstår når bedriften har betalt mer skatt enn det regnskapsmessige resultatet tilsier. Kan motregnes mot fremtidig skatteforpliktelse.", ex: "Fremførbart underskudd, midlertidige forskjeller" },
  { n: "1080", name: "Goodwill", group: "10 Immaterielle eiendeler", types: ["AS"], desc: "Merverdi betalt ved oppkjøp av virksomhet utover identifiserbare eiendeler. Representerer omdømme, kunderelasjoner og markedsposisjon. Avskrives over inntil ti år.", ex: "Oppkjøpspremie, virksomhetsoverdragelse" },
