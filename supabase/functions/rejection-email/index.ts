        ...
        <tr>
          <td style="padding:40px 40px 20px 40px;">
            ...
            <div style="text-align:center;margin:28px 0;">
              <a href="https://obsidian-edge-finance.lovable.app/karriere/tilbakemelding" style="display:inline-block;background-color:#1a1a1a;color:#ffffff;font-size:14px;font-weight:600;padding:14px 32px;border-radius:10px;text-decoration:none;letter-spacing:0.3px;">
