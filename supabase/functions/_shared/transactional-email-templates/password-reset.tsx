  ...
  <Html lang="nb" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={p}>Hei! Vi mottok en forespørsel om å tilbakestille passordet på Avargo-kontoen din.</Text>
        ...
        <Hr style={hr} />
        <Text style={footer}>Sendt til {recipient_email} fra Avargo · kontakt@avargo.no</Text>
      </Container>
    </Body>
  </Html>
)
...
export const template = {
  component: Email,
  subject: 'Avargo — Tilbakestill passordet ditt',
